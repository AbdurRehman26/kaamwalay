                    ...
                    <tbody class="pop-list__table-body">
                        ...
                        @foreach($data as $i => $cardSetsReport)
                            <tr class="pop-list__table-row">
                                ...
                                @include('landings.pop.partials.value-cell',['href' => route('pop.set', ['cardCategory' => $cardCategory->id, 'cardSeries' => $cardSetsReport->card_series_id, 'cardSet' => $cardSetsReport->card_set_id]), 'zeroValue' => $cardSetsReport->pr, 'plusValue' => $cardSetsReport->fr])
