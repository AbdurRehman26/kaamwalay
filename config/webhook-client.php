...
use App\Services\Webhooks\ProcessCvatWebhookJob;
use App\Services\Webhooks\ProcessSlabPhotoWebhookJob;
...
return [
    'configs' => [
        [
             ...
             */
            'process_webhook_job' => ProcessCvatWebhookJob::class,
        ],
        [
            /*
             * This package supports multiple webhook receiving endpoints. If you only have
             ...
             * This should be set to a class that extends \Spatie\WebhookClient\ProcessWebhookJob.
             */
            'process_webhook_job' => ProcessSlabPhotoWebhookJob::class,
        ],
    ],
];
