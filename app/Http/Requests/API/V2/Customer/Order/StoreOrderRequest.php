...
class StoreOrderRequest extends V1StoreOrderRequest
{
    public function rules(): array
    {
        $rules = [
            ...
            'shipping_address.country_code' => ['sometimes', 'nullable', 'exists:countries,code'],
            ...
            'billing_address.address_2' => ['nullable', 'string'],
            ...
            'billing_address.country_code' => ['sometimes', 'nullable', 'exists:countries,code'],
