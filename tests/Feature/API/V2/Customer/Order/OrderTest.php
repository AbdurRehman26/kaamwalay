...
it('can calculate collector coin price for an order', function () {
    ...
    $response = $this->getJson('/api/v2/customer/orders/' . $order->id . '/collector-coin?payment_blockchain_network=97');
...
it('throws error if using unsupported network', function () {
    ...
    $response = $this->getJson('/api/v2/customer/orders/' . $order->id . '/collector-coin?payment_blockchain_network=1');
