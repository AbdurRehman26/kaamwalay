/**
 * @api {get} /v1/admin/coupons List coupons
 ...
 *            ],
 *            "links": {
 *                "first": "http://robograding.test/api/v1/admin/coupons?page=1",
 *                "last": "http://robograding.test/api/v1/admin/coupons?page=1",
 *                "prev": null,
 *                "next": null
 *            },
 *            "meta": {
 ...
 *                    },
 *                    {
 *                        "url": "http://robograding.test/api/v1/admin/coupons?page=1",
 *                        "label": "1",
 *                        "active": true
 *                    },
 *                    {
 ...
 *                    }
 *                ],
 *                "path": "http://robograding.test/api/v1/admin/coupons",
 *                "per_page": 15,
 *                "to": 15,
 *                "total": 15
 *            }
