<section class="Home-section Home-testimonial">
    <div class="Home-sectionColumn Home-sectionColumn--half Home-testimonialContentHolder">
        <div class="Home-testimonialContent">
            ...
            <div class="Home-testimonialProfile" data-aos="fade-up"data-aos-delay="200">
                ...
                <div class="Home-testimonialProfileName">
                    ...
                    <p class="Home-testimonialProfileNameText">Collector</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="Home-sectionColumn Home-sectionColumn--half">
        <img src="{{ asset('assets/images/landings/home/testimonialImage.jpg') }}" alt=""
             class="Home-testimonialImage" />
    </div>
</section>
