 ...
 *                 }
 *             ],
 *             "first_page_url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=1",
 *             "from": 1,
 *             "last_page": 5,
 *             "last_page_url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=5",
 *             "links": [
 *                 {
 *                     "url": null,
 ...
 *                 },
 *                 {
 *                     "url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=1",
 *                     "label": "1",
 *                     "active": true
 *                 },
 *                 {
 *                     "url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=2",
 *                     "label": "2",
 *                     "active": false
 *                 },
 *                 {
 *                     "url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=3",
 *                     "label": "3",
 *                     "active": false
 *                 },
 *                 {
 *                     "url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=4",
 *                     "label": "4",
 *                     "active": false
 *                 },
 *                 {
 *                     "url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=5",
 *                     "label": "5",
 *                     "active": false
 *                 },
 *                 {
 ...
 *                 }
 *             ],
 *             "next_page_url": "http://robograding.test/api/v2/pop/categories/1/series/1?per_page=2&page=2",
