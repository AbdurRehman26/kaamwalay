...
test('admin checks for valid coupon code on wrong service level', function () {
    actingAs($this->user);
...
test('admin checks for valid coupon code having items less than required', function ($count) {
    actingAs($this->user);
...
test('admin checks for valid coupon code having more or equal required cards count', function ($count) {
    actingAs($this->user);
...
test('admin checks for valid coupon code having more or equal required cards count with already created order', function () {
    actingAs($this->user);
...
test('admin checks for valid coupon code having less than the required cards count with already created order', function () {
    actingAs($this->user);
