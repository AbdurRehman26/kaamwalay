...
import SalesRepSubmissionsList from '@shared/components/SalesReps/SalesRepSubmissionsList';
...
export function SalesRepViewSubmissionsTab() {
    ...
    return (
        <Root container>
            <Grid container item xs className={'SalesRepSubmissionListingBox'}>
                    ...
                    <>
                        {orders$.data.length !== 0 || ordersCount !== 0 ? (
                            <>
                                ...
                                <TableContainer>
                                    <SalesRepSubmissionsList
                                        orders={orders$.data}
                                        paginationProp={orders$.paginationProps}
                                        isSalesRepDetailPage={true}
                                        headings={headings}
                            ...
                            >
                                ...
                                <Grid item xs={12}>
                                    <Typography variant={'body1'} textAlign={'center'} fontSize={12}>
                                        This salesman has no submissions, yet.
                                    </Typography>
                                </Grid>
                            </Grid>
                        )}
...
export default SalesRepViewSubmissionsTab;
