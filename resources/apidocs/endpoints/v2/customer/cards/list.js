/**
 * @api {get} /v2/customer/cards List cards
 * @apiName List Cards
 * @apiGroup User Cards
 *
 * @apiVersion 2.0.0
 ...
 *         ],
 *         "links": {
 *             "first": "http://robograding.test/api/v2/customer/17/cards?page=1",
 *             "last": "http://robograding.test/api/v2/customer/17/cards?page=1",
 *             "prev": null,
 *             "next": null
 *         },
 *         "meta": {
 ...
 *                 },
 *                 {
 *                     "url": "http://robograding.test/api/v2/customer/17/cards?page=1",
 *                     "label": "1",
 *                     "active": true
 *                 },
 *                 {
 ...
 *                 }
 *             ],
 *             "path": "http://robograding.test/api/v2/customer/17/cards",
 *             "per_page": 15,
 *             "to": 3,
 *             "total": 3
 *         }
