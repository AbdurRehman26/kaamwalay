<section class="ReferralHome-sectionCommunity">
    <div class="container ReferralHome-sectionContainer ReferralHome-sectionContainer--center-center" data-aos="fade-up">
        <div class="ReferralHome-sectionColumn ReferralHome-sectionColumn--half ReferralHome-sectionColumn--center-center">
            <h4 class="ReferralHome-sectionContentCaption text-center">THE AGS COMMUNITY</h4>
            <h3 class="ReferralHome-sectionContentHeadline text-center">15,000 Strong & Growing</h3>
        </div>
    </div>
    ...
    <div class="container ReferralHome-sectionContainer ReferralHome-featuresGrid" data-aos="fade-up"data-aos-delay="100">
        <div class="ReferralHome-sectionColumn ReferralHome-sectionColumn--fourth">
            <div class="ReferralHome-featureColumn">
        ...
        <div class="container text-center">
            <button onclick="(function(){window.scrollTo(0, 0)})()" class="ReferralHome-button">Join Them</button>
        </div>
    </div>
</section>
