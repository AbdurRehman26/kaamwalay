...
import { changePromoCodeStatus, deletePromoCode } from '@shared/redux/slices/salesmanPromoCodesSlice';
...
export function PromoCodesTableRow({ promoCode }: PromoCodesTableRowProps) {
    ...
    return (
        <TableRow>
            ...
            <TableCell align={'left'}>{promoCode?.couponStats?.totalCards}</TableCell>
            <TableCell align={'left'}>${promoCode?.couponStats?.totalDiscount}</TableCell>
            <TableCell align={'left'}>
                {user.id === promoCode?.createdBy?.id ? 'You' : promoCode?.createdBy?.getFullName()}
            </TableCell>
            <TableCell align={'right'} className={classes.optionsCell}>
                {user.id === promoCode?.createdBy?.id ? (
