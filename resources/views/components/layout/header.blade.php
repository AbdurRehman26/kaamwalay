<header @class([
    ...
    <div class="page__header__nav-holder">
        <nav class="page__header__nav">
            ...
            <a href="{{ url('/authentication') }}" class="page__header__nav-item {{str_contains(Route::currentRouteName(), 'authentication.index') ? 'page__header__nav-item--active' : null}}">Authentication</a>
