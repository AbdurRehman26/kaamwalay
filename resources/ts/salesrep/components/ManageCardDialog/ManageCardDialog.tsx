...
import ManageCardDialogCreateCard from './ManageCardDialogCreateCard';
import ManageCardDialogCreateSeries from './ManageCardDialogCreateSeries';
import ManageCardDialogCreateSet from './ManageCardDialogCreateSet';
import ManageCardDialogEdit from './ManageCardDialogEdit';
...
export function ManageCardDialog({ onAdd, ...rest }: ManageCardDialogProps) {
    ...
    return (
        <Dialog open={dialogState.open} classes={{ paper: classes.paper }} scroll={'body'} maxWidth={'sm'} {...rest}>
            ...
            <Slide
                in={dialogState.view === ManageCardDialogViewEnum.CreateSet}
                direction={'left'}
                unmountOnExit
                exit={false}
            >
                <ManageCardDialogCreateSet onAdd={onAdd} declaredValue={dialogState.declaredValue} />
            </Slide>
        </Dialog>
    );
}
