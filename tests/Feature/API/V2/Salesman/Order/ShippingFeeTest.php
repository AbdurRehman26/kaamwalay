...
test('an salesman can get shipping fee', function () {
    $response = $this->postJson('/api/v2/salesman/orders/shipping-fee/', [
        'items' => [
            [
                'quantity' => 1,
...
test('shipping fee is calculated based on provided shipping method', function (ShippingMethod $shippingMethod) {
    $this->postJson('/api/v2/salesman/orders/shipping-fee', [
        'items' => [
            [
                'quantity' => 1,
                'declared_value_per_unit' => 500,
