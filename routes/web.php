...
Route::prefix('feed')->group(function () {
    ...
    Route::get('/{certificateId}/view', [FeedController::class, 'getView'])->name('feed.cardView');
});
Route::get('card/{certificateId}', [FeedController::class, 'cardRedirect'])->name('feed.view');
