...
it('sync users to mailchimp', function () {
    ...
    // $res = $this->test->shouldReceive('handle')->with("Test Service")->andReturn(true);

    //  dd($this->artisan('sync:users'));   
